    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('share_price', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Price of Share')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_pin', models.PositiveIntegerField(unique=True, validators=[django.core.validators.MinValueValidator(10000000), django.core.validators.MaxValueValidator(99999999)])),
                ('share_no', models.PositiveIntegerField(verbose_name='No of Share')),
                ('share_price', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Price of Share')),
